  ...
  "inline-flex items-center justify-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        gold:
          "border-[hsl(var(--accent-gold))] bg-gradient-gold text-white shadow-gold hover:shadow-tier-gold animate-trophy",
        trophy:
          "border-transparent bg-gradient-trophy text-white shadow-tier-gold font-bold uppercase tracking-wide",
        mvp:
          "border-transparent bg-[hsl(var(--tier-mvp))] text-white shadow-soft hover:shadow-lg font-bold",
        stat:
          "border-primary/40 bg-primary/10 text-primary hover:bg-primary/20 hover:border-primary",
        goal:
          "border-[hsl(var(--goal-indicator))]/20 bg-[hsl(var(--goal-indicator))]/10 text-[hsl(var(--goal-indicator))] font-semibold hover:bg-[hsl(var(--goal-indicator))]/20",
        assist:
        ...
        glass:
          "glass-pitch border-primary/30 text-primary hover:border-primary/50",
      },
      size: {
