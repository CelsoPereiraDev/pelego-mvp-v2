      ...
      <div className="w-full max-w-md mx-4">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Um Fut é o seu grupo de futebol. Adicione jogadores, registre partidas e acompanhe
            estatísticas.
          </p>
        </div>
        ...
        <form
          ...
          className="space-y-4 bg-card rounded-xl p-6 border border-border shadow-sm">
          <div>
