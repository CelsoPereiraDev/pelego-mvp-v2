...
import StrikerMPPImage from '@/../public/chuteira_mpp.svg';
import StrikerMVPImage from '@/../public/chuteira_mvp.svg';
import StrikerNormalImage from '@/../public/chuteira_simple.svg';
import StrikerMonthImage from '@/../public/chuteira_striker.svg';
import StrikerWeekImage from '@/../public/chuteira_week.svg';
import flagImage from '@/../public/Flag_BR.png';
import vanuatu from '@/../public/Flag_Gloriosa.png';
import India from '@/../public/Flag_IN.png';
...
export const VanuatuFlagImage = vanuatu;

export const IndianFlagImage = India;

export const NH = NHImage;
...
export const StrikerMPP = StrikerMPPImage;

export const monthWinner = monthWinnerImage;

export const StrikerMonth = StrikerMonthImage;
